...
def index(request):
    ...
    return render(
        ...
        "gallery/index.html",
        {
            ...
            "all_photos_page_size": getattr(settings, "MAX_JSON_PAGE_SIZE", 200),
        },
    )


def get_upload_context(form):
    return {
        "form": form,
...
def upload_photo(request):
    ...
    if request.method == "POST":
        if not form.is_valid():
            ...
            return render(request, "gallery/upload.html", get_upload_context(form), status=400)
        ...
        if uploaded_count == 0:
            ...
            return render(
                request,
                "gallery/upload.html",
                get_upload_context(PhotoUploadForm()),
                status=400,
            )
    ...
    return render(request, "gallery/upload.html", get_upload_context(form))
